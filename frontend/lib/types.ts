...
export interface Money { amount: number; currency: "IRT" }
...
export type ModeDetails =
  | { mode: "flight"; origin_airport_code: string; destination_airport_code: string; airline: string; flight_number: string; fare_type: "system" | "charter"; cabin_class: string; baggage_allowance_kg?: number | null }
  | { mode: "train"; railway_company: string; train_number: string; class_name: string; compartment_capacity?: number | null; private_compartment_available?: boolean | null; women_only_available?: boolean | null; vehicle_transport_available?: boolean | null }
  | { mode: "bus"; origin_terminal: string; destination_terminal: string; company: string; service_number?: string | null; bus_class: string; seat_selection_available?: boolean | null; capacity?: number | null; cancellation_policy?: string | null };
